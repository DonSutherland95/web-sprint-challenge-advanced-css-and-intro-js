...
1. How would you describe acessibility on the web to someone new to programming?
   Websites with acessibility means that websites, tools, and technologies are designed and developed so that people with disabilities can use the
2. Talk about 3 different things you can do to ensure your website is accessible.
   Use semantic html, scalable units, use colors that contrast well as well as use symbols to show importance on a web page.
3. How would you explain the concept of a variable to someone new to programming?
   Variable means anything that can vary. JavaScript includes variables which hold the data value and it can be changed anytim
4. What is the purpose of using functions in code?Functions and procedures are the basic building blocks of programs
